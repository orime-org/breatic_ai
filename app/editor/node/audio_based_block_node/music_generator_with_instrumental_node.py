...
class MusicGeneratorNode(BaseAudioNode):
    ...
    async def input_data(self,model_id: str,params: dict):
        ...
        for item in user_prompts:
            input_items.append((item, {"model": model_id,"instrumental": True, "duration": self.get_duration(params)}))
...
music_generator_with_instrumental_node_instance = MusicGeneratorNode()